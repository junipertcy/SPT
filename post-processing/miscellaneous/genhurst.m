% genhurst.m (Downloaded from the web)
%
% Calculates Hurst exponent from a trajectory. You will obtain an
% exponent from each dimension. Note for true brownian motion, the
% exponent is close to 0.5; while for FBM, it is less than 0.5
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
